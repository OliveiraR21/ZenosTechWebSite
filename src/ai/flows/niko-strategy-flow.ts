...
Based on the history, generate the next appropriate response for NIKO, following all the rules above. The response should be a single string for the \`insight\` field.`,
});
